...
```{r ans32}
credit100chosenStudent<- sum((studentID=="046S6f645"& schoolYear=="100")*credit)
...
```{r ans33}
sum((studentID=="046S6f645"& schoolYear=="100"& grade>="60")*credit)
earnedCredit100chosenStudent <-sum((studentID=="046S6f645"& schoolYear=="100"& grade>="60")*credit)
...
```{r ans34}
abc<-studentID=="046S6f645"& schoolYear=="100"& credit>="0"
gpa100ChosenStudent<-sum(abc*credit*grade)/sum((studentID=="046S6f645"& schoolYear=="100")*credit)
gpa100ChosenStudent
```
